...
- **Object store (v0.5.59–68)**: named blobs; `$OBJ.<name>` on PUBLISH when persist_dir is set (D4 phases 3 and 5)
...
- **HTTP/2 (v0.5.66–69)**: HPACK static codec + preface/SETTINGS/32-stream machine (D2 phases 1–2; no `h2` advertise)

...
- **OTel span ring (v0.5.61)**: lock-free 256-slot sidecar export (D1 phase 1; no payload bodies)
- **JWT / NKEY (v0.5.62–63)**: HS256 JWT on CONNECT; Ed25519 nkey of `CMQNK1|<user>` when `nkey_pub` is set (D3 phases 1–2)

...
- **JWT / NKEY / JWKS (v0.5.62–65, 0.5.74–77)**: HS256 / ES256 / RS256 JWT on CONNECT; Ed25519 nkey of `CMQNK1|<user>` (`nkey_pub` is 64 hex or NATS `U…`); JWKS oct/EC/RSA `kid` cache + HTTP `jwks_url` (D3 phases 1–7)

...
### D3 JWT / NKEY / JWKS — phases 1–6 shipped v0.5.62–65, 0.5.74–76

HS256 JWT, ES256 (P-256), Ed25519 nkey on CONNECT (`U…` or
64 hex), static JWKS, and HTTP `jwks_url` fetch are live.
**Remaining:** RSA, HTTPS JWKS. Still verify-only.
